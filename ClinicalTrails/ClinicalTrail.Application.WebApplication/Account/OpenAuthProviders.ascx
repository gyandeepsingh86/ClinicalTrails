<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="ClinicalTrail.Application.WebApplication.Account.OpenAuthProviders" %>
